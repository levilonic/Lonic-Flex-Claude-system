#!/usr/bin/env node
/**
 * repository-config-manager Test Suite
 * Category: SERVICE
 */
...
async function runTests() {
    console.log('\n🧪 repository-config-manager (SERVICE)\n');

    // Test 1: Module loads
    try {
        const module = require('../../src/services/repository-config-manager');
    ...
    try {
        require('../../src/services/repository-config-manager');
