#!/usr/bin/env node
/**
 * context-engineering-engine Test Suite
 * Category: CORE
 */
...
async function runTests() {
    console.log('\n🧪 context-engineering-engine (CORE)\n');

    // Test 1: Module loads
    try {
        const module = require('../../src/core/context-engineering-engine');
    ...
    try {
        require('../../src/core/context-engineering-engine');
