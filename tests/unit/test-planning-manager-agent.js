#!/usr/bin/env node
/**
 * planning-manager-agent Test Suite
 * Category: AGENT
 */
...
async function runTests() {
    console.log('\n🧪 planning-manager-agent (AGENT)\n');

    // Test 1: Module loads
    try {
        const module = require('../../src/agents/planning-manager-agent');
    ...
    try {
        require('../../src/agents/planning-manager-agent');
