#!/usr/bin/env node
/**
 * pragmatic-code-reviewer Test Suite
 * Category: AGENT
 */
...
async function runTests() {
    console.log('\n🧪 pragmatic-code-reviewer (AGENT)\n');

    // Test 1: Module loads
    try {
        const module = require('../../src/agents/pragmatic-code-reviewer');
    ...
    try {
        require('../../src/agents/pragmatic-code-reviewer');
