#!/usr/bin/env node
/**
 * multiplan-manager-agent Test Suite
 * Category: AGENT
 */
...
async function runTests() {
    console.log('\n🧪 multiplan-manager-agent (AGENT)\n');

    // Test 1: Module loads
    try {
        const module = require('../../src/agents/multiplan-manager-agent');
    ...
    try {
        require('../../src/agents/multiplan-manager-agent');
