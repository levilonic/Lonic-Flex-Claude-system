#!/usr/bin/env node
/**
 * conditional-workflow-engine Test Suite
 * Category: SERVICE
 */
...
async function runTests() {
    console.log('\n🧪 conditional-workflow-engine (SERVICE)\n');

    // Test 1: Module loads
    try {
        const module = require('../../src/services/conditional-workflow-engine');
    ...
    try {
        require('../../src/services/conditional-workflow-engine');
