#!/usr/bin/env node
/**
 * protocol-research-agent Test Suite
 * Category: AGENT
 */
...
async function runTests() {
    console.log('\n🧪 protocol-research-agent (AGENT)\n');

    // Test 1: Module loads
    try {
        const module = require('../../src/agents/protocol-research-agent');
    ...
    try {
        require('../../src/agents/protocol-research-agent');
