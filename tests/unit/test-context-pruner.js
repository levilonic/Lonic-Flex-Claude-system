#!/usr/bin/env node
/**
 * ContextPruner Test Suite - Auto-Generated
 * Category: CONTEXT
 */
...
async function runTests() {
    ...
    try {
        ...
        try {
            const module = require('../../src/context-management/context-pruner');
        ...
        try {
            const module = require('../../src/context-management/context-pruner');
            const primaryExport = module.ContextPruner || module.default || module;
        ...
        try {
            const module = require('../../src/context-management/context-pruner');
            const Constructor = module.ContextPruner;
        ...
        console.log('\n📋 Test 5: Module Independence...');
        try {
            const module1 = require('../../src/context-management/context-pruner');
            const module2 = require('../../src/context-management/context-pruner');
